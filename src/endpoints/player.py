...
class Player(EndpointsBase):
    ...
    def get_playback_state(
        self, market: Optional[MARKET] = None, additional_types: Optional[str] = None
    ):
    ...
    def get_recently_played_tracks(
        self, limit: Optional[int] = None, query_range: Optional[QueryRange] = None
    ):
    ...
    def transfer_playback(self, device_ids: list[str], play: Optional[bool] = None):
        ...
        self.put_request("me/player", {"device_ids": device_ids, "play": play})
    ...
    def start_resume_playback(
        ...
        params = EndpointsBase.params_for({"device_id": device_id})
        self.put_request(
    ...
    def set_repeat_mode(
        self, state: Literal["track", "context", "off"], device_id: Optional[str] = None
    ):
        params = EndpointsBase.params_for({"state": state, "device_id": device_id})
    ...
    def add_item_to_playback_queue(self, uri: str, device_id: Optional[str] = None):
        params = EndpointsBase.params_for({"uri": uri, "device_id": device_id})
