...
@pytest.mark.asyncio
async def test_get_episode_single_item_async(api, get_episode_data):
    result = await api.episodes.get(get_episode_data["id"], "GB")
...
@pytest.mark.asyncio
async def test_get_episode_multiple_items_async(api, get_episode_data):
    result = await api.episodes.get([get_episode_data["id"], get_episode_data["id"]], "GB")
